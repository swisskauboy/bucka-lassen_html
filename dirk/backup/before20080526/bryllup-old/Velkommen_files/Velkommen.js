IMpreload('Velkommen_files', 'shapeimage_3', '0');
...
function onPageLoad()
{
    ...
    fixupAllIEPNGBGs();
    fixupIEPNG("id3", "Velkommen_files/transparent.gif");
    fixupIEPNG("id4", "Velkommen_files/transparent.gif");
    fixupIEPNG("id5", "Velkommen_files/transparent.gif");
    fixupIEPNG("id6", "Velkommen_files/transparent.gif");
    fixupIEPNG("id7", "Velkommen_files/transparent.gif");
    fixupIEPNG("shapeimage_3_link_0", "Velkommen_files/transparent.gif");
    fixupIEPNG("shapeimage_3", "Velkommen_files/transparent.gif");
    return true;
}
