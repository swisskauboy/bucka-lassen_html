IMpreload('Willkommen_files', 'shapeimage_3', '0');
...
function onPageLoad()
{
    ...
    fixupIEPNG("id5", "Willkommen_files/transparent.gif");
    fixupIEPNG("id6", "Willkommen_files/transparent.gif");
    fixupIEPNG("id7", "Willkommen_files/transparent.gif");
    fixupIEPNG("shapeimage_3_link_0", "Willkommen_files/transparent.gif");
    fixupIEPNG("shapeimage_3", "Willkommen_files/transparent.gif");
    return true;
}
